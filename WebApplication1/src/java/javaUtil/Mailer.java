...
public class Mailer {
    ...
    public void enviarCorreo(EMail mail, byte[] archivo) throws AddressException, MessagingException {
        ...
        String mime = "";
        if (mail.getImagen() != null) {
            
            
            adjunto = new MimeBodyPart();
            mime ="image/jpeg";
            dataSource = new ByteArrayDataSource(archivo, mime);
            adjunto.setDataHandler(new DataHandler(dataSource));
            adjunto.setFileName("EventoMuna" + "." + "jpeg");
        ...
        //msj.setRecipient(Message.RecipientType.TO, destinatario);RecipientType.BCC
       // msj.setRecipients(Message.RecipientType.TO, toList);
       msj.setRecipients(Message.RecipientType.BCC, toList);
